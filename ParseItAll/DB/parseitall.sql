...
# Date: 2017-01-20 19:47:46
# Generator: MySQL-Front 5.4  (Build 4.151) - http://www.mysqlfront.de/
...
REPLACE INTO `job_regexp_type_ref` VALUES (1,'accept if match in inside HTML'),(2,''),(3,'delete if match');
...
REPLACE INTO `job_rule_records` VALUES (3,13,'alt_title',1),(4,14,'title',1),(5,15,'ru_country',1),(6,17,'ru_name',1),(7,25,'ru_content',1),(8,20,'ru_country',0),(9,21,'ru_city',0),(10,22,'ru_address',0),(11,23,'site',0),(12,24,'site',0);
...
REPLACE INTO `job_regexp` VALUES (1,2,'-g(\\d){3,}-',1),(2,4,'/Hotels-',1),(5,9,'-oa(\\d)+-',1),(7,18,'Следующая',1),(8,25,'\\[.*\\]',3);
...
REPLACE INTO `links` VALUES (13857,4,1,1,'https://www.tripadvisor.ru/SiteIndex','259e648a0b263a265c02b31b0d9afa4b',NULL);
